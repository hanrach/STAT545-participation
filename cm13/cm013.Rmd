...
1. It is clear what is being shown, the x-axis and y-axis are labelled clearly.

1. The scales shown on the plot is appropriate for the data given.

1. Too many colors subtract from the clarity

1. The type of plot being used is suitable.
...
1. Apply Principle of proportional ink (more emphasis on significants parts of data but not skewed/exaggerated)

1. less is more, remove special effects and colors. But good use of color is important still.

1. Update axes labels and titles

1.  Choose scale wisely
